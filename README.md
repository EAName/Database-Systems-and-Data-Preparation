...
- **Data warehouse / BI SQL:** standalone PDF deliverables for business-intelligence query patterns on relational and warehouse-style schemas
- **Schema design:** entity-relationship diagram deliverable; normalization through business rules deliverable
- **Graph data / Cypher:** fraud-detection Cypher query language deliverable
